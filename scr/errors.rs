...
impl LunaError {
    ...
    pub(crate) fn invalid_pos(doc_id: DocumentId, position: Position, detail: impl Into<String>) -> Self {
        Self::InvalidPosition { doc_id, position, detail: detail.into() }
    }

    pub(crate) fn invalid_range(doc_id: DocumentId, range: Range, detail: impl Into<String>) -> Self {
